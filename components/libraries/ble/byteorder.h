...
#define __bswap_32(x)                                                                              \
    ((uint32_t)((((x) >> 24) & 0xff) | (((x) >> 8) & 0xff00) | (((x)&0xff00) << 8) |               \
                (((x)&0xff) << 24)))
#define __bswap_48(x)                                                                              \
    ((uint64_t)((((x) >> 40) & 0xff) | (((x) >> 24) & 0xff00) | (((x) >> 8) & 0xff0000) |          \
                (((x)&0xff0000) << 8) | (((x)&0xff00) << 24) | (((x)&0xff) << 40)))
#define __bswap_64(x)                                                                              \
    ((uint64_t)((((x) >> 56) & 0xff) | (((x) >> 40) & 0xff00) | (((x) >> 24) & 0xff0000) |         \
                (((x) >> 8) & 0xff000000) | (((x)&0xff000000) << 8) | (((x)&0xff0000) << 24) |     \
