...
void bt_smp_encrypt_change(struct bt_conn *conn, uint8_t hci_status);
...
int bt_smp_recv(struct bt_conn *conn, simple_buf_t *buf);

#if defined (CONFIG_BTP_TESTER)
void bt_smp_set_mitm(uint8_t flag);
#endif
